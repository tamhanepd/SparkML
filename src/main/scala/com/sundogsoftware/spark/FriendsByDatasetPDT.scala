...
//
//    println("Let's select multiple columns")
//    people.select("name", "age").show()

//    println("Group by age:")
//    people.groupBy("age").count().show()

    println("Average grouped data for each age")
    people.groupBy("age").avg("friends").show()

    println("Average grouped data for each age sorted")
